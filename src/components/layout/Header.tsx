    ...
    <header className="sticky top-0 z-30 border-b border-slate-800/80 bg-slate-950/90 backdrop-blur-md">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 md:px-6">
        <div className="flex min-w-0 items-center gap-3">
          <div className="grid size-11 shrink-0 place-items-center rounded-xl border border-orange-300/45 bg-orange-500/16 text-orange-300 shadow-[0_0_28px_rgba(249,115,22,0.24)]">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-0.5 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs font-medium text-slate-400">
              <span className="inline-flex items-center gap-1">
                <Sparkles size={14} aria-hidden="true" />
                Simulación interactiva de transferencia de calor
              </span>
            </p>
          </div>
        </div>
